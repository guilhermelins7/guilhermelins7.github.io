      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="mb-24">
          <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
            ...
            <h2 className="max-w-2xl text-5xl md:text-7xl font-display font-bold leading-tight mb-8">
              Tem um projeto ou proposta em mente? <br />
              Vamos conversar!
            </h2>
            </div>
            <a
              className="mt-12 lg:mt-0 lg:self-center w-32 h-32 shrink-0 bg-primary rounded-full flex items-center justify-center text-white font-medium text-center hover:scale-110 transition-transform duration-300 shadow-xl z-20 hover:rotate-12"
          ...
          <div className="flex flex-col gap-8 mt-12 xl:flex-row xl:items-end xl:justify-between">
            <div className="flex flex-col gap-8 text-sm text-gray-600 dark:text-gray-400 sm:flex-row">
              <div>
            ...
            <div className="w-full xl:w-auto">
                <p className="mb-3 text-sm font-bold uppercase tracking-widest text-primary xl:text-right">
                  Links profissionais
                </p>
                <nav
                  aria-label="Links profissionais"
                  className="grid w-full grid-cols-1 gap-3 sm:grid-cols-3 xl:w-auto"
                >
                  <a
